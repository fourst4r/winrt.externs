    ...
    implements winrt.microsoft.windows.appnotifications.IAppNotificationManager2
{
    ...
    overload function Register(displayName: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, iconUri: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.Uri>): Void;

...
@:native("winrt::Microsoft::Windows::AppNotifications::Builder::IAppNotificationProgressBar")
extern interface IAppNotificationProgressBar extends winrt.windows.foundation.IInspectable
{

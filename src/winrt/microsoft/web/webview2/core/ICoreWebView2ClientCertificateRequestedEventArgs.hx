...
@:native("winrt::Microsoft::Web::WebView2::Core::ICoreWebView2ClientCertificateRequestedEventArgs")
extern interface ICoreWebView2ClientCertificateRequestedEventArgs extends winrt.windows.foundation.IInspectable
{
    ...
    overload function SelectedCertificate(value: cxx.ConstRef<winrt.microsoft.web.webview2.core.CoreWebView2ClientCertificate>): Void;

    ...
    implements winrt.microsoft.ui.windowing.IDisplayArea
{
    ...
    static function GetFromWindowId(windowId: ConstRef<winrt.microsoft.ui.WindowId>, displayAreaFallback: ConstRef<winrt.microsoft.ui.windowing.DisplayAreaFallback>): winrt.microsoft.ui.windowing.DisplayArea;
    static function GetFromPoint(point: ConstRef<winrt.windows.graphics.PointInt32>, displayAreaFallback: ConstRef<winrt.microsoft.ui.windowing.DisplayAreaFallback>): winrt.microsoft.ui.windowing.DisplayArea;
    static function GetFromRect(rect: ConstRef<winrt.windows.graphics.RectInt32>, displayAreaFallback: ConstRef<winrt.microsoft.ui.windowing.DisplayAreaFallback>): winrt.microsoft.ui.windowing.DisplayArea;
    static function GetFromDisplayId(displayId: ConstRef<winrt.microsoft.ui.DisplayId>): winrt.microsoft.ui.windowing.DisplayArea;
}

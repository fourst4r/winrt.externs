...
{
    function TryUpdateScaleWithAnimation(animation: cxx.ConstRef<winrt.microsoft.ui.composition.CompositionAnimation>, centerPoint: cxx.ConstRef<winrt.windows.foundation.numerics.Vector3>): cxx.num.Int32;
    ...
    function ConfigurePositionXInertiaModifiers(modifiers: cxx.ConstRef<winrt.windows.foundation.collections.IIterable<winrt.microsoft.ui.composition.interactions.InteractionTrackerInertiaModifier> /* temp_GenericTypeInstSig */>): Void;
    function ConfigurePositionYInertiaModifiers(modifiers: cxx.ConstRef<winrt.windows.foundation.collections.IIterable<winrt.microsoft.ui.composition.interactions.InteractionTrackerInertiaModifier> /* temp_GenericTypeInstSig */>): Void;
    function ConfigureScaleInertiaModifiers(modifiers: cxx.ConstRef<winrt.windows.foundation.collections.IIterable<winrt.microsoft.ui.composition.interactions.InteractionTrackerInertiaModifier> /* temp_GenericTypeInstSig */>): Void;
    ...
    function TryUpdatePositionWithAnimation(animation: cxx.ConstRef<winrt.microsoft.ui.composition.CompositionAnimation>): cxx.num.Int32;
    ...
    overload function TryUpdatePosition(value: cxx.ConstRef<winrt.windows.foundation.numerics.Vector3>, option: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTrackerClampingOption>): cxx.num.Int32;
    overload function TryUpdatePositionBy(amount: cxx.ConstRef<winrt.windows.foundation.numerics.Vector3>, option: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTrackerClampingOption>): cxx.num.Int32;
    overload function IsInertiaFromImpulse(): Bool;
    overload function TryUpdatePosition(value: cxx.ConstRef<winrt.windows.foundation.numerics.Vector3>, option: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTrackerClampingOption>, posUpdateOption: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTrackerPositionUpdateOption>): cxx.num.Int32;
    ...
    static function Create(compositor: cxx.ConstRef<winrt.microsoft.ui.composition.Compositor>): winrt.microsoft.ui.composition.interactions.InteractionTracker;
    static function CreateWithOwner(compositor: cxx.ConstRef<winrt.microsoft.ui.composition.Compositor>, owner: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.IInteractionTrackerOwner>): winrt.microsoft.ui.composition.interactions.InteractionTracker;
    static function SetBindingMode(boundTracker1: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTracker>, boundTracker2: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTracker>, axisMode: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionBindingAxisModes>): Void;
    static function GetBindingMode(boundTracker1: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTracker>, boundTracker2: cxx.ConstRef<winrt.microsoft.ui.composition.interactions.InteractionTracker>): winrt.microsoft.ui.composition.interactions.InteractionBindingAxisModes;
}

    ...
    implements winrt.microsoft.ui.xaml.automation.IAutomationAnnotation
{
    function new();
    @:native("winrt::Microsoft::UI::Xaml::Automation::AutomationAnnotation")
    /* explicit */ static overload function make(type: ConstRef<winrt.microsoft.ui.xaml.automation.AnnotationType>): winrt.microsoft.ui.xaml.automation.AutomationAnnotation;
    @:native("winrt::Microsoft::UI::Xaml::Automation::AutomationAnnotation")
    static overload function make(type: ConstRef<winrt.microsoft.ui.xaml.automation.AnnotationType>, element: ConstRef<winrt.microsoft.ui.xaml.UIElement>): winrt.microsoft.ui.xaml.automation.AutomationAnnotation;

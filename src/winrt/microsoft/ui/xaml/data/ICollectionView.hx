...
extern interface ICollectionView extends winrt.windows.foundation.IInspectable
{
    ...
    overload function CurrentChanging(handler: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.data.CurrentChangingEventHandler>): winrt.EventToken;

...
extern interface ICommandBar extends winrt.windows.foundation.IInspectable
{
    ...
    overload function CommandBarOverflowPresenterStyle(value: ConstRef<winrt.microsoft.ui.xaml.Style>): Void;
    ...
    overload function DefaultLabelPosition(value: ConstRef<winrt.microsoft.ui.xaml.controls.CommandBarDefaultLabelPosition>): Void;
    overload function OverflowButtonVisibility(): winrt.microsoft.ui.xaml.controls.CommandBarOverflowButtonVisibility;
    overload function OverflowButtonVisibility(value: ConstRef<winrt.microsoft.ui.xaml.controls.CommandBarOverflowButtonVisibility>): Void;
    overload function IsDynamicOverflowEnabled(): Bool;
    overload function IsDynamicOverflowEnabled(value: Bool): Void;
    overload function DynamicOverflowItemsChanging(handler: ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.microsoft.ui.xaml.controls.CommandBar, winrt.microsoft.ui.xaml.controls.DynamicOverflowItemsChangingEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;

    ...
    implements winrt.microsoft.ui.xaml.controls.IRadioMenuFlyoutItem
{
    ...
    static function SetAreCheckStatesEnabled(object: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.controls.MenuFlyoutSubItem>, value: Bool): Void;
    static function GetAreCheckStatesEnabled(object: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.controls.MenuFlyoutSubItem>): Bool;
}

...
@:native("winrt::Microsoft::UI::Xaml::Controls::AnimatedVisuals::AnimatedGlobalNavigationButtonVisualSource")
extern class AnimatedGlobalNavigationButtonVisualSource

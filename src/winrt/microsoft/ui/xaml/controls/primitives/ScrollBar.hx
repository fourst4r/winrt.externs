...
@:native("winrt::Microsoft::UI::Xaml::Controls::Primitives::ScrollBar")
extern class ScrollBar
    extends winrt.microsoft.ui.xaml.controls.primitives.RangeBase
    implements winrt.microsoft.ui.xaml.controls.primitives.IScrollBar
{
    function new();
    ...
    static overload function ViewportSizeProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static overload function IndicatorModeProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
}

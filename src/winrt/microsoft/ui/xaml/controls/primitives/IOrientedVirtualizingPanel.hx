...
@:native("winrt::Microsoft::UI::Xaml::Controls::Primitives::IOrientedVirtualizingPanel")
extern interface IOrientedVirtualizingPanel extends winrt.windows.foundation.IInspectable
{

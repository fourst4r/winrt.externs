    ...
    implements winrt.microsoft.ui.xaml.controls.primitives.IFlyoutBaseOverrides
{
    ...
    static function GetAttachedFlyout(element: ConstRef<winrt.microsoft.ui.xaml.FrameworkElement>): winrt.microsoft.ui.xaml.controls.primitives.FlyoutBase;
    static function SetAttachedFlyout(element: ConstRef<winrt.microsoft.ui.xaml.FrameworkElement>, value: ConstRef<winrt.microsoft.ui.xaml.controls.primitives.FlyoutBase>): Void;
    static function ShowAttachedFlyout(flyoutOwner: ConstRef<winrt.microsoft.ui.xaml.FrameworkElement>): Void;
}

...
{
    @:native("winrt::Microsoft::UI::Xaml::Controls::Primitives::DragCompletedEventArgs")
    static overload function make(horizontalChange: cxx.num.Float64, verticalChange: cxx.num.Float64, canceled: Bool): winrt.microsoft.ui.xaml.controls.primitives.DragCompletedEventArgs;

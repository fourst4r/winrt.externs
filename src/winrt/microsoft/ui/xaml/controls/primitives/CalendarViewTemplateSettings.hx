...
@:native("winrt::Microsoft::UI::Xaml::Controls::Primitives::CalendarViewTemplateSettings")
extern class CalendarViewTemplateSettings
    extends winrt.microsoft.ui.xaml.DependencyObject
    implements winrt.microsoft.ui.xaml.controls.primitives.ICalendarViewTemplateSettings
{

    ...
    implements winrt.microsoft.ui.xaml.controls.IExpander
{
    ...
    overload function ExpandDirection(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.controls.ExpandDirection>): Void;
    overload function Expanding(handler: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.TypedEventHandler<winrt.microsoft.ui.xaml.controls.Expander, winrt.microsoft.ui.xaml.controls.ExpanderExpandingEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    @:noExcept overload function Expanding(token: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.EventToken>): Void;
    overload function Collapsed(handler: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.TypedEventHandler<winrt.microsoft.ui.xaml.controls.Expander, winrt.microsoft.ui.xaml.controls.ExpanderCollapsedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;

    ...
    implements winrt.windows.foundation.collections.IVector<winrt.microsoft.ui.xaml.controls.SwipeItem> /* GenericTypeInstSig */
{
    ...
    function GetAt(index: UInt32): winrt.microsoft.ui.xaml.controls.SwipeItem;
    ...
    function IndexOf(value: ConstRef<winrt.microsoft.ui.xaml.controls.SwipeItem>, index: Ref<UInt32>): Bool;
    function SetAt(index: UInt32, value: ConstRef<winrt.microsoft.ui.xaml.controls.SwipeItem>): Void;
    function InsertAt(index: UInt32, value: ConstRef<winrt.microsoft.ui.xaml.controls.SwipeItem>): Void;
    function RemoveAt(index: UInt32): Void;
    function Append(value: ConstRef<winrt.microsoft.ui.xaml.controls.SwipeItem>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: UInt32, items: winrt.ArrayView<winrt.microsoft.ui.xaml.controls.SwipeItem>): UInt32;

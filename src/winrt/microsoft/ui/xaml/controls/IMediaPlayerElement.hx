...
extern interface IMediaPlayerElement extends winrt.windows.foundation.IInspectable
{
    ...
    overload function TransportControls(value: ConstRef<winrt.microsoft.ui.xaml.controls.MediaTransportControls>): Void;
    ...
    overload function PosterSource(value: ConstRef<winrt.microsoft.ui.xaml.media.ImageSource>): Void;
    ...
    function SetMediaPlayer(mediaPlayer: ConstRef<winrt.windows.media.playback.MediaPlayer>): Void;
}

    ...
    implements winrt.microsoft.ui.xaml.controls.IRelativePanel
{
    ...
    static function GetLeftOf(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetLeftOf(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AboveProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAbove(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAbove(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function RightOfProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetRightOf(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetRightOf(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function BelowProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetBelow(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetBelow(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignHorizontalCenterWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignHorizontalCenterWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignHorizontalCenterWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignVerticalCenterWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignVerticalCenterWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignVerticalCenterWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignLeftWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignLeftWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignLeftWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignTopWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignTopWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignTopWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignRightWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignRightWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignRightWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignBottomWithProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignBottomWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignBottomWith(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignLeftWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignLeftWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignLeftWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignTopWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignTopWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignTopWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignRightWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignRightWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignRightWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignBottomWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignBottomWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignBottomWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignHorizontalCenterWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignHorizontalCenterWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignHorizontalCenterWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignVerticalCenterWithPanelProperty(): winrt.microsoft.ui.xaml.DependencyProperty;
    static function GetAlignVerticalCenterWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>): Bool;
    static function SetAlignVerticalCenterWithPanel(element: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.microsoft.ui.xaml.UIElement>, value: Bool): Void;

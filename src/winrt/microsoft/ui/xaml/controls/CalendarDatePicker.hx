...
{
    @:native("winrt::Microsoft::UI::Xaml::Controls::CalendarDatePicker")
    static overload function make(): winrt.microsoft.ui.xaml.controls.CalendarDatePicker;
    ...
    overload function CalendarViewStyle(value: cxx.ConstRef<winrt.microsoft.ui.xaml.Style>): Void;
    ...
    overload function CalendarViewDayItemChanging(handler: cxx.ConstRef<winrt.microsoft.ui.xaml.controls.CalendarViewDayItemChangingEventHandler>): winrt.EventToken;
    @:noExcept overload function CalendarViewDayItemChanging(token: cxx.ConstRef<winrt.EventToken>): Void;
    overload function DateChanged(handler: cxx.ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.microsoft.ui.xaml.controls.CalendarDatePicker, winrt.microsoft.ui.xaml.controls.CalendarDatePickerDateChangedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;

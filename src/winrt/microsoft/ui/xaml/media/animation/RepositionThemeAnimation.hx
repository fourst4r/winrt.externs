...
@:native("winrt::Microsoft::UI::Xaml::Media::Animation::RepositionThemeAnimation")
extern class RepositionThemeAnimation
    extends winrt.microsoft.ui.xaml.media.animation.Timeline
    implements winrt.microsoft.ui.xaml.media.animation.IRepositionThemeAnimation
{
    function new();

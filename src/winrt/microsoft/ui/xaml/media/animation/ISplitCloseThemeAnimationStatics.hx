...
@:native("winrt::Microsoft::UI::Xaml::Media::Animation::ISplitCloseThemeAnimationStatics")
extern interface ISplitCloseThemeAnimationStatics extends winrt.windows.foundation.IInspectable
{

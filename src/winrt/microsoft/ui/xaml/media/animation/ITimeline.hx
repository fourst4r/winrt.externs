...
extern interface ITimeline extends winrt.windows.foundation.IInspectable
{
    ...
    overload function Duration(value: ConstRef<winrt.microsoft.ui.xaml.Duration>): Void;
    ...
    overload function FillBehavior(value: ConstRef<winrt.microsoft.ui.xaml.media.animation.FillBehavior>): Void;
    overload function RepeatBehavior(): winrt.microsoft.ui.xaml.media.animation.RepeatBehavior;
    overload function RepeatBehavior(value: ConstRef<winrt.microsoft.ui.xaml.media.animation.RepeatBehavior>): Void;

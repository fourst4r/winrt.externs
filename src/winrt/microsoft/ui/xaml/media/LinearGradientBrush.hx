    ...
    implements winrt.microsoft.ui.xaml.media.ILinearGradientBrush
{
    function new();
    @:native("winrt::Microsoft::UI::Xaml::Media::LinearGradientBrush")
    static overload function make(gradientStopCollection: cxx.ConstRef<winrt.microsoft.ui.xaml.media.GradientStopCollection>, angle: cxx.num.Float64): winrt.microsoft.ui.xaml.media.LinearGradientBrush;

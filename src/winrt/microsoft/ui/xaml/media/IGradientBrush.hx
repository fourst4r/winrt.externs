...
extern interface IGradientBrush extends winrt.windows.foundation.IInspectable
{
    ...
    overload function ColorInterpolationMode(value: ConstRef<winrt.microsoft.ui.xaml.media.ColorInterpolationMode>): Void;
    overload function GradientStops(): winrt.microsoft.ui.xaml.media.GradientStopCollection;
    overload function GradientStops(value: ConstRef<winrt.microsoft.ui.xaml.media.GradientStopCollection>): Void;
}

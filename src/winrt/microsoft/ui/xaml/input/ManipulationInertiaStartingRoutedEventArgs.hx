    ...
    implements winrt.microsoft.ui.xaml.input.IManipulationInertiaStartingRoutedEventArgs
{
    ...
    overload function ExpansionBehavior(value: cxx.ConstRef<winrt.microsoft.ui.xaml.input.InertiaExpansionBehavior>): Void;
    overload function RotationBehavior(): winrt.microsoft.ui.xaml.input.InertiaRotationBehavior;
    overload function RotationBehavior(value: cxx.ConstRef<winrt.microsoft.ui.xaml.input.InertiaRotationBehavior>): Void;
    overload function TranslationBehavior(): winrt.microsoft.ui.xaml.input.InertiaTranslationBehavior;
    overload function TranslationBehavior(value: cxx.ConstRef<winrt.microsoft.ui.xaml.input.InertiaTranslationBehavior>): Void;

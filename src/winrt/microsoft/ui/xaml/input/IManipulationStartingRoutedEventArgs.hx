...
extern interface IManipulationStartingRoutedEventArgs extends winrt.windows.foundation.IInspectable
{
    ...
    overload function Mode(value: ConstRef<winrt.microsoft.ui.xaml.input.ManipulationModes>): Void;
    overload function Container(): winrt.microsoft.ui.xaml.UIElement;
    overload function Container(value: ConstRef<winrt.microsoft.ui.xaml.UIElement>): Void;
    overload function Pivot(): winrt.microsoft.ui.xaml.input.ManipulationPivot;
    overload function Pivot(value: ConstRef<winrt.microsoft.ui.xaml.input.ManipulationPivot>): Void;

    ...
    implements winrt.windows.ui.windowmanagement.IWindowingEnvironment
{
    ...
    overload function Changed(handler: ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.ui.windowmanagement.WindowingEnvironment, winrt.windows.ui.windowmanagement.WindowingEnvironmentChangedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    ...
    static overload function FindAll(kind: ConstRef<winrt.windows.ui.windowmanagement.WindowingEnvironmentKind>): winrt.windows.foundation.collections.IVectorView<winrt.windows.ui.windowmanagement.WindowingEnvironment> /* GenericTypeInstSig */;
}

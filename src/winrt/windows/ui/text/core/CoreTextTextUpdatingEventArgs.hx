...
@:native("winrt::Windows::UI::Text::Core::CoreTextTextUpdatingEventArgs")
extern class CoreTextTextUpdatingEventArgs
    implements winrt.windows.ui.text.core.ICoreTextTextUpdatingEventArgs
{

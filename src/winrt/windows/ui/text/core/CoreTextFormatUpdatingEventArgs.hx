...
extern class CoreTextFormatUpdatingEventArgs
    implements winrt.windows.ui.text.core.ICoreTextFormatUpdatingEventArgs
{
    ...
    overload function Result(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.text.core.CoreTextFormatUpdatingResult>): Void;

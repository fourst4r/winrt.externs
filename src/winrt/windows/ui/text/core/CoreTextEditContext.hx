...
@:native("winrt::Windows::UI::Text::Core::CoreTextEditContext")
extern class CoreTextEditContext
    implements winrt.windows.ui.text.core.ICoreTextEditContext
    implements winrt.windows.ui.text.core.ICoreTextEditContext2
{

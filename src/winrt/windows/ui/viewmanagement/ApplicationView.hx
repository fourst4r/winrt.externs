    ...
    implements winrt.windows.ui.viewmanagement.IApplicationViewWithContext
{
    ...
    static function GetApplicationViewIdForWindow(window: cxx.ConstRef<winrt.windows.ui.core.ICoreWindow>): cxx.num.Int32;
    ...
    static overload function PreferredLaunchWindowingMode(value: cxx.ConstRef<winrt.windows.ui.viewmanagement.ApplicationViewWindowingMode>): Void;
    static overload function PreferredLaunchViewSize(): winrt.windows.foundation.Size;
    static overload function PreferredLaunchViewSize(value: cxx.ConstRef<winrt.windows.foundation.Size>): Void;
    static function ClearAllPersistedState(): Void;
    static function ClearPersistedState(key: cxx.ConstRef<winrt.HString>): Void;
}

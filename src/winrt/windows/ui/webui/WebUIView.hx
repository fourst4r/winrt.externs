    ...
    implements winrt.windows.web.ui.IWebViewControl2
{
    ...
    static overload function CreateAsync(uri: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.Uri>): winrt.windows.foundation.IAsyncOperation<winrt.windows.ui.webui.WebUIView> /* GenericTypeInstSig */;
}

...
@:native("winrt::Windows::UI::WebUI::WebUIAppointmentsProviderShowTimeFrameActivatedEventArgs")
extern class WebUIAppointmentsProviderShowTimeFrameActivatedEventArgs

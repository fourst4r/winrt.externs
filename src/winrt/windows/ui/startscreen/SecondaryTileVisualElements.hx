...
{
    overload function Square30x30Logo(value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;
    overload function Square30x30Logo(): winrt.windows.foundation.Uri;
    overload function Square70x70Logo(value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;
    overload function Square70x70Logo(): winrt.windows.foundation.Uri;
    overload function Square150x150Logo(value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;
    overload function Square150x150Logo(): winrt.windows.foundation.Uri;
    overload function Wide310x150Logo(value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;
    overload function Wide310x150Logo(): winrt.windows.foundation.Uri;
    overload function Square310x310Logo(value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;

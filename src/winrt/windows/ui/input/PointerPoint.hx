    ...
    implements winrt.windows.ui.input.IPointerPoint
{
    ...
    static overload function GetCurrentPoint(pointerId: UInt32): winrt.windows.ui.input.PointerPoint;
    static overload function GetIntermediatePoints(pointerId: UInt32): winrt.windows.foundation.collections.IVector<winrt.windows.ui.input.PointerPoint> /* GenericTypeInstSig */;
    static overload function GetCurrentPoint(pointerId: UInt32, transform: ConstRef<winrt.windows.ui.input.IPointerPointTransform>): winrt.windows.ui.input.PointerPoint;
    static overload function GetIntermediatePoints(pointerId: UInt32, transform: ConstRef<winrt.windows.ui.input.IPointerPointTransform>): winrt.windows.foundation.collections.IVector<winrt.windows.ui.input.PointerPoint> /* GenericTypeInstSig */;
}

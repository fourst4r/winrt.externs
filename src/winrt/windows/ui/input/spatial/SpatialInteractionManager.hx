    ...
    implements winrt.windows.ui.input.spatial.ISpatialInteractionManager
{
    ...
    static function IsSourceKindSupported(kind: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.input.spatial.SpatialInteractionSourceKind>): Bool;
}

...
@:native("winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisInkWord")
extern class InkAnalysisInkWord
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisNode
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisInkWord
{

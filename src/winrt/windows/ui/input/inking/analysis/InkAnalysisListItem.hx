...
@:native("winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisListItem")
extern class InkAnalysisListItem
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisNode
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisListItem
{

...
@:native("winrt::Windows::UI::Input::Inking::Analysis::InkAnalysisLine")
extern class InkAnalysisLine
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisNode
    implements winrt.windows.ui.input.inking.analysis.IInkAnalysisLine
{

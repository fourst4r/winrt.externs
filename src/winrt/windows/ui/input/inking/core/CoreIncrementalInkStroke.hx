...
{
    function new(drawingAttributes: cxx.ConstRef<winrt.windows.ui.input.inking.InkDrawingAttributes>, pointTransform: cxx.ConstRef<winrt.windows.foundation.numerics.Matrix3x2>);

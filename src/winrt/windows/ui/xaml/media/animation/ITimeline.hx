...
extern interface ITimeline extends winrt.windows.foundation.IInspectable
{
    ...
    overload function Duration(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.Duration>): Void;
    ...
    overload function FillBehavior(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.media.animation.FillBehavior>): Void;
    overload function RepeatBehavior(): winrt.windows.ui.xaml.media.animation.RepeatBehavior;
    overload function RepeatBehavior(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.media.animation.RepeatBehavior>): Void;

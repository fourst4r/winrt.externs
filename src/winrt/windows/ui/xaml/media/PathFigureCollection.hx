...
{
    function new();
    function GetAt(index: cxx.num.UInt32): winrt.windows.ui.xaml.media.PathFigure;
    ...
    function IndexOf(value: cxx.ConstRef<winrt.windows.ui.xaml.media.PathFigure>, index: cxx.Ref<cxx.num.UInt32>): Bool;
    function SetAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.ui.xaml.media.PathFigure>): Void;
    function InsertAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.ui.xaml.media.PathFigure>): Void;
    function RemoveAt(index: cxx.num.UInt32): Void;
    function Append(value: cxx.ConstRef<winrt.windows.ui.xaml.media.PathFigure>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: cxx.num.UInt32, items: winrt.ArrayView<winrt.windows.ui.xaml.media.PathFigure>): cxx.num.UInt32;

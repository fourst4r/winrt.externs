    ...
    implements winrt.windows.ui.xaml.media.imaging.ISvgImageSource
{
    function new();
    @:native("winrt::Windows::UI::Xaml::Media::Imaging::SvgImageSource")
    /* explicit */ static overload function make(uriSource: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.Uri>): winrt.windows.ui.xaml.media.imaging.SvgImageSource;

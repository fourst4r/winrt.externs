    ...
    implements winrt.windows.ui.xaml.IGridLengthHelper
{
    ...
    static function FromPixels(pixels: cxx.num.Float64): winrt.windows.ui.xaml.GridLength;
    static function FromValueAndType(value: cxx.num.Float64, type: cxx.ConstRef<winrt.windows.ui.xaml.GridUnitType>): winrt.windows.ui.xaml.GridLength;
    static function GetIsAbsolute(target: cxx.ConstRef<winrt.windows.ui.xaml.GridLength>): Bool;
    static function GetIsAuto(target: cxx.ConstRef<winrt.windows.ui.xaml.GridLength>): Bool;
    static function GetIsStar(target: cxx.ConstRef<winrt.windows.ui.xaml.GridLength>): Bool;
    static function Equals(target: cxx.ConstRef<winrt.windows.ui.xaml.GridLength>, value: cxx.ConstRef<winrt.windows.ui.xaml.GridLength>): Bool;
}

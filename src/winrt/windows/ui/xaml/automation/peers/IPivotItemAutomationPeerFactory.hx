...
{
    function CreateInstanceWithOwner(owner: ConstRef<winrt.windows.ui.xaml.controls.PivotItem>): winrt.windows.ui.xaml.automation.peers.PivotItemAutomationPeer;
}

...
{
    @:native("winrt::Windows::UI::Xaml::Automation::Peers::ItemsControlAutomationPeer")
    /* explicit */ static overload function make(owner: cxx.ConstRef<winrt.windows.ui.xaml.controls.ItemsControl>): winrt.windows.ui.xaml.automation.peers.ItemsControlAutomationPeer;

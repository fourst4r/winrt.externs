...
{
    @:native("winrt::Windows::UI::Xaml::Automation::Peers::ScrollViewerAutomationPeer")
    /* explicit */ static overload function make(owner: cxx.ConstRef<winrt.windows.ui.xaml.controls.ScrollViewer>): winrt.windows.ui.xaml.automation.peers.ScrollViewerAutomationPeer;

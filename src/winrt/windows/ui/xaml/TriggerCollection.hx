...
{
    function GetAt(index: UInt32): winrt.windows.ui.xaml.TriggerBase;
    ...
    function IndexOf(value: ConstRef<winrt.windows.ui.xaml.TriggerBase>, index: Ref<UInt32>): Bool;
    function SetAt(index: UInt32, value: ConstRef<winrt.windows.ui.xaml.TriggerBase>): Void;
    function InsertAt(index: UInt32, value: ConstRef<winrt.windows.ui.xaml.TriggerBase>): Void;
    function RemoveAt(index: UInt32): Void;
    function Append(value: ConstRef<winrt.windows.ui.xaml.TriggerBase>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: UInt32, items: winrt.ArrayView<winrt.windows.ui.xaml.TriggerBase>): UInt32;

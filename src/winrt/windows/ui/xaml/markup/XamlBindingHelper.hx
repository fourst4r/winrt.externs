    ...
    implements winrt.windows.ui.xaml.markup.IXamlBindingHelper
{
    ...
    static function GetDataTemplateComponent(element: cxx.ConstRef<winrt.windows.ui.xaml.DependencyObject>): winrt.windows.ui.xaml.markup.IDataTemplateComponent;
    static function SetDataTemplateComponent(element: cxx.ConstRef<winrt.windows.ui.xaml.DependencyObject>, value: cxx.ConstRef<winrt.windows.ui.xaml.markup.IDataTemplateComponent>): Void;
    static function SuspendRendering(target: cxx.ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    static function ResumeRendering(target: cxx.ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    ...
    static function SetPropertyFromString(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.HString>): Void;
    static function SetPropertyFromBoolean(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: Bool): Void;
    static function SetPropertyFromChar16(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.Char): Void;
    static function SetPropertyFromDateTime(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.DateTime>): Void;
    static function SetPropertyFromDouble(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.Float64): Void;
    static function SetPropertyFromInt32(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.Int32): Void;
    static function SetPropertyFromUInt32(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.UInt32): Void;
    static function SetPropertyFromInt64(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.Int64): Void;
    static function SetPropertyFromUInt64(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.UInt64): Void;
    static function SetPropertyFromSingle(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.Float32): Void;
    static function SetPropertyFromPoint(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.Point>): Void;
    static function SetPropertyFromRect(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.Rect>): Void;
    static function SetPropertyFromSize(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.Size>): Void;
    static function SetPropertyFromTimeSpan(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.TimeSpan>): Void;
    static function SetPropertyFromByte(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.num.UInt8): Void;
    static function SetPropertyFromUri(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.Uri>): Void;
    static function SetPropertyFromObject(dependencyObject: cxx.ConstRef<winrt.windows.foundation.IInspectable>, propertyToSet: cxx.ConstRef<winrt.windows.ui.xaml.DependencyProperty>, value: cxx.ConstRef<winrt.windows.foundation.IInspectable>): Void;
}

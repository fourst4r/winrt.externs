...
extern interface IManipulationInertiaStartingRoutedEventArgs extends winrt.windows.foundation.IInspectable
{
    ...
    overload function ExpansionBehavior(value: cxx.ConstRef<winrt.windows.ui.xaml.input.InertiaExpansionBehavior>): Void;
    overload function RotationBehavior(): winrt.windows.ui.xaml.input.InertiaRotationBehavior;
    overload function RotationBehavior(value: cxx.ConstRef<winrt.windows.ui.xaml.input.InertiaRotationBehavior>): Void;
    overload function TranslationBehavior(): winrt.windows.ui.xaml.input.InertiaTranslationBehavior;
    overload function TranslationBehavior(value: cxx.ConstRef<winrt.windows.ui.xaml.input.InertiaTranslationBehavior>): Void;

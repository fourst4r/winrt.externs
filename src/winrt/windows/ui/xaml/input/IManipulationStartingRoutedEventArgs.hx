...
extern interface IManipulationStartingRoutedEventArgs extends winrt.windows.foundation.IInspectable
{
    ...
    overload function Mode(value: ConstRef<winrt.windows.ui.xaml.input.ManipulationModes>): Void;
    overload function Container(): winrt.windows.ui.xaml.UIElement;
    overload function Container(value: ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    overload function Pivot(): winrt.windows.ui.xaml.input.ManipulationPivot;
    overload function Pivot(value: ConstRef<winrt.windows.ui.xaml.input.ManipulationPivot>): Void;

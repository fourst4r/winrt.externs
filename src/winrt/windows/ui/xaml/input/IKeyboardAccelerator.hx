...
extern interface IKeyboardAccelerator extends winrt.windows.foundation.IInspectable
{
    ...
    overload function ScopeOwner(value: ConstRef<winrt.windows.ui.xaml.DependencyObject>): Void;
    overload function Invoked(handler: ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.ui.xaml.input.KeyboardAccelerator, winrt.windows.ui.xaml.input.KeyboardAcceleratorInvokedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;

    ...
    implements winrt.windows.ui.xaml.controls.IRelativePanel2
{
    ...
    static function GetLeftOf(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetLeftOf(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AboveProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAbove(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAbove(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function RightOfProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetRightOf(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetRightOf(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function BelowProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetBelow(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetBelow(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignHorizontalCenterWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignHorizontalCenterWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignHorizontalCenterWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignVerticalCenterWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignVerticalCenterWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignVerticalCenterWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignLeftWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignLeftWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignLeftWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignTopWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignTopWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignTopWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignRightWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignRightWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignRightWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignBottomWithProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignBottomWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>): winrt.windows.foundation.IInspectable;
    static function SetAlignBottomWith(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: ConstRef<winrt.windows.foundation.IInspectable>): Void;
    static overload function AlignLeftWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignLeftWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignLeftWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignTopWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignTopWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignTopWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignRightWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignRightWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignRightWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignBottomWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignBottomWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignBottomWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignHorizontalCenterWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignHorizontalCenterWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignHorizontalCenterWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;
    static overload function AlignVerticalCenterWithPanelProperty(): winrt.windows.ui.xaml.DependencyProperty;
    static function GetAlignVerticalCenterWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>): Bool;
    static function SetAlignVerticalCenterWithPanel(element: ConstRef<winrt.windows.ui.xaml.UIElement>, value: Bool): Void;

...
@:native("winrt::Windows::UI::Xaml::Controls::Maps::MapContextRequestedEventArgs")
extern class MapContextRequestedEventArgs
    implements winrt.windows.ui.xaml.controls.maps.IMapContextRequestedEventArgs
{
    function new();

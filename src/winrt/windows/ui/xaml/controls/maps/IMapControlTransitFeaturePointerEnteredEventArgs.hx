...
@:native("winrt::Windows::UI::Xaml::Controls::Maps::IMapControlTransitFeaturePointerEnteredEventArgs")
extern interface IMapControlTransitFeaturePointerEnteredEventArgs extends winrt.windows.foundation.IInspectable
{

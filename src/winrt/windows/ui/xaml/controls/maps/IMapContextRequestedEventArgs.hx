...
@:native("winrt::Windows::UI::Xaml::Controls::Maps::IMapContextRequestedEventArgs")
extern interface IMapContextRequestedEventArgs extends winrt.windows.foundation.IInspectable
{

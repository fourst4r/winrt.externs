    ...
    implements winrt.windows.ui.xaml.controls.maps.IHttpMapTileDataSource
{
    function new();
    @:native("winrt::Windows::UI::Xaml::Controls::Maps::HttpMapTileDataSource")
    /* explicit */ static overload function make(uriFormatString: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.ui.xaml.controls.maps.HttpMapTileDataSource;

...
@:native("winrt::Windows::UI::Xaml::Controls::Maps::IMapControlTransitFeaturePointerExitedEventArgs")
extern interface IMapControlTransitFeaturePointerExitedEventArgs extends winrt.windows.foundation.IInspectable
{

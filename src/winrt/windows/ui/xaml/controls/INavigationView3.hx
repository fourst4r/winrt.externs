...
extern interface INavigationView3 extends winrt.windows.foundation.IInspectable
{
    ...
    overload function PaneDisplayMode(value: ConstRef<winrt.windows.ui.xaml.controls.NavigationViewPaneDisplayMode>): Void;
    overload function PaneHeader(): winrt.windows.ui.xaml.UIElement;
    overload function PaneHeader(value: ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    overload function PaneCustomContent(): winrt.windows.ui.xaml.UIElement;
    overload function PaneCustomContent(value: ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    overload function ContentOverlay(): winrt.windows.ui.xaml.UIElement;
    overload function ContentOverlay(value: ConstRef<winrt.windows.ui.xaml.UIElement>): Void;
    ...
    overload function SelectionFollowsFocus(value: ConstRef<winrt.windows.ui.xaml.controls.NavigationViewSelectionFollowsFocus>): Void;
    ...
    overload function ShoulderNavigationEnabled(value: ConstRef<winrt.windows.ui.xaml.controls.NavigationViewShoulderNavigationEnabled>): Void;
    overload function OverflowLabelMode(): winrt.windows.ui.xaml.controls.NavigationViewOverflowLabelMode;
    overload function OverflowLabelMode(value: ConstRef<winrt.windows.ui.xaml.controls.NavigationViewOverflowLabelMode>): Void;
}

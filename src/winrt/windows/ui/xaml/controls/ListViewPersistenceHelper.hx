    ...
    implements winrt.windows.ui.xaml.controls.IListViewPersistenceHelper
{
    ...
    static function GetRelativeScrollPosition(listViewBase: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.controls.ListViewBase>, itemToKeyHandler: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.controls.ListViewItemToKeyHandler>): winrt.HString;
    static function SetRelativeScrollPositionAsync(listViewBase: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.controls.ListViewBase>, relativeScrollPosition: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, keyToItemHandler: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.controls.ListViewKeyToItemHandler>): winrt.windows.foundation.IAsyncAction;
}

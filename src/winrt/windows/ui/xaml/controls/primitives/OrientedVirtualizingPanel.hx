...
@:native("winrt::Windows::UI::Xaml::Controls::Primitives::OrientedVirtualizingPanel")
extern class OrientedVirtualizingPanel
    extends winrt.windows.ui.xaml.controls.VirtualizingPanel
    implements winrt.windows.ui.xaml.controls.primitives.IOrientedVirtualizingPanel

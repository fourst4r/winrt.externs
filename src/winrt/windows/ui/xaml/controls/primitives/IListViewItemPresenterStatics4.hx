...
@:native("winrt::Windows::UI::Xaml::Controls::Primitives::IListViewItemPresenterStatics4")
extern interface IListViewItemPresenterStatics4 extends winrt.windows.foundation.IInspectable
{

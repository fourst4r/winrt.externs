...
extern interface IPersonPicture extends winrt.windows.foundation.IInspectable
{
    ...
    overload function BadgeImageSource(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.media.ImageSource>): Void;
    ...
    overload function ProfilePicture(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.ui.xaml.media.ImageSource>): Void;
}

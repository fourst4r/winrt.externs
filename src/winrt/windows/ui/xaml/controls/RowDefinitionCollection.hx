...
{
    function GetAt(index: cxx.num.UInt32): winrt.windows.ui.xaml.controls.RowDefinition;
    ...
    function IndexOf(value: cxx.ConstRef<winrt.windows.ui.xaml.controls.RowDefinition>, index: cxx.Ref<cxx.num.UInt32>): Bool;
    function SetAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.ui.xaml.controls.RowDefinition>): Void;
    function InsertAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.ui.xaml.controls.RowDefinition>): Void;
    function RemoveAt(index: cxx.num.UInt32): Void;
    function Append(value: cxx.ConstRef<winrt.windows.ui.xaml.controls.RowDefinition>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: cxx.num.UInt32, items: winrt.ArrayView<winrt.windows.ui.xaml.controls.RowDefinition>): cxx.num.UInt32;

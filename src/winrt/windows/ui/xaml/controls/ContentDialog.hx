    ...
    implements winrt.windows.ui.xaml.controls.IContentDialog3
{
    ...
    overload function ShowAsync(placement: cxx.ConstRef<winrt.windows.ui.xaml.controls.ContentDialogPlacement>): winrt.windows.foundation.IAsyncOperation<winrt.windows.ui.xaml.controls.ContentDialogResult> /* GenericTypeInstSig */;

    ...
    implements winrt.windows.ui.xaml.documents.IContentLink
{
    ...
    overload function Info(value: ConstRef<winrt.windows.ui.text.ContentLinkInfo>): Void;
    ...
    overload function Cursor(value: ConstRef<winrt.windows.ui.core.CoreCursorType>): Void;
    ...
    overload function Invoked(handler: ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.ui.xaml.documents.ContentLink, winrt.windows.ui.xaml.documents.ContentLinkInvokedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;

...
{
    function Lookup(key: ConstRef<winrt.HString>): winrt.windows.ui.composition.scenes.SceneAttributeSemantic;
    ...
    function Insert(key: ConstRef<winrt.HString>, value: ConstRef<winrt.windows.ui.composition.scenes.SceneAttributeSemantic>): Bool;

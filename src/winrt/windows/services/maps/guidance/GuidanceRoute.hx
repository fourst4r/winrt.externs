    ...
    implements winrt.windows.services.maps.guidance.IGuidanceRoute
{
    ...
    static function CanCreateFromMapRoute(mapRoute: ConstRef<winrt.windows.services.maps.MapRoute>): Bool;
    static function TryCreateFromMapRoute(mapRoute: ConstRef<winrt.windows.services.maps.MapRoute>): winrt.windows.services.maps.guidance.GuidanceRoute;
}

...
{
    overload function DataUsagePreference(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.services.maps.MapServiceDataUsagePreference>): Void;

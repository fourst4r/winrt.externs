    ...
    implements winrt.windows.perception.spatial.ISpatialStageFrameOfReference
{
    ...
    static overload function CurrentChanged(handler: cxx.ConstRef<winrt.windows.foundation.EventHandler<winrt.windows.foundation.IInspectable> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    static overload function CurrentChanged(cookie: cxx.ConstRef<winrt.EventToken>): Void;

    ...
    implements winrt.windows.perception.spatial.ISpatialBoundingVolume
{
    ...
    static function FromBox(coordinateSystem: ConstRef<winrt.windows.perception.spatial.SpatialCoordinateSystem>, box: ConstRef<winrt.windows.perception.spatial.SpatialBoundingBox>): winrt.windows.perception.spatial.SpatialBoundingVolume;
    static function FromOrientedBox(coordinateSystem: ConstRef<winrt.windows.perception.spatial.SpatialCoordinateSystem>, box: ConstRef<winrt.windows.perception.spatial.SpatialBoundingOrientedBox>): winrt.windows.perception.spatial.SpatialBoundingVolume;
    static function FromSphere(coordinateSystem: ConstRef<winrt.windows.perception.spatial.SpatialCoordinateSystem>, sphere: ConstRef<winrt.windows.perception.spatial.SpatialBoundingSphere>): winrt.windows.perception.spatial.SpatialBoundingVolume;
    static function FromFrustum(coordinateSystem: ConstRef<winrt.windows.perception.spatial.SpatialCoordinateSystem>, frustum: ConstRef<winrt.windows.perception.spatial.SpatialBoundingFrustum>): winrt.windows.perception.spatial.SpatialBoundingVolume;
}

...
{
    function Create(webTokenResponse: cxx.ConstRef<winrt.windows.security.authentication.web.core.WebTokenResponse>): winrt.windows.security.authentication.web.provider.WebProviderTokenResponse;
}

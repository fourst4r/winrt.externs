...
@:native("winrt::Windows::Security::Authentication::OnlineId::OnlineIdAuthenticator")
extern class OnlineIdAuthenticator
    implements winrt.windows.security.authentication.onlineid.IOnlineIdAuthenticator
{
    function new();

...
extern class CertificateStores
{
    ...
    static function GetStoreByName(storeName: cxx.ConstRef<winrt.HString>): winrt.windows.security.cryptography.certificates.CertificateStore;
    static function GetUserStoreByName(storeName: cxx.ConstRef<winrt.HString>): winrt.windows.security.cryptography.certificates.UserCertificateStore;
}

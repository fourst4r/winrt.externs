...
@:native("winrt::Windows::Security::Cryptography::Certificates::PfxImportParameters")
extern class PfxImportParameters
    implements winrt.windows.security.cryptography.certificates.IPfxImportParameters
{
    function new();

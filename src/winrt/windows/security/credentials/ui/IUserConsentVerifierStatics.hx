...
extern interface IUserConsentVerifierStatics extends winrt.windows.foundation.IInspectable
{
    ...
    function RequestVerificationAsync(message: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.security.credentials.ui.UserConsentVerificationResult> /* GenericTypeInstSig */;
}

...
@:native("winrt::Windows::Devices::HumanInterfaceDevice::IHidNumericControlDescription")
extern interface IHidNumericControlDescription extends winrt.windows.foundation.IInspectable
{

    ...
    implements winrt.windows.devices.enumeration.IDeviceInformationPairing2
{
    ...
    overload function PairAsync(minProtectionLevel: ConstRef<winrt.windows.devices.enumeration.DevicePairingProtectionLevel>, devicePairingSettings: ConstRef<winrt.windows.devices.enumeration.IDevicePairingSettings>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.enumeration.DevicePairingResult> /* GenericTypeInstSig */;
    ...
    static function TryRegisterForAllInboundPairingRequests(pairingKindsSupported: ConstRef<winrt.windows.devices.enumeration.DevicePairingKinds>): Bool;
    static function TryRegisterForAllInboundPairingRequestsWithProtectionLevel(pairingKindsSupported: ConstRef<winrt.windows.devices.enumeration.DevicePairingKinds>, minProtectionLevel: ConstRef<winrt.windows.devices.enumeration.DevicePairingProtectionLevel>): Bool;
}

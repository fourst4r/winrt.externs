...
@:native("winrt::Windows::Devices::Enumeration::DeviceInformationCustomPairing")
extern class DeviceInformationCustomPairing
    implements winrt.windows.devices.enumeration.IDeviceInformationCustomPairing
{

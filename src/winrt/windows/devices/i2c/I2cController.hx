    ...
    implements winrt.windows.devices.i2c.II2cController
{
    ...
    function GetControllersAsync(provider: cxx.ConstRef<winrt.windows.devices.i2c.provider.II2cProvider>): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVectorView<winrt.windows.devices.i2c.I2cController> /* GenericTypeInstSig */> /* GenericTypeInstSig */;
    ...
    static function GetControllersAsync(provider: cxx.ConstRef<winrt.windows.devices.i2c.provider.II2cProvider>): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVectorView<winrt.windows.devices.i2c.I2cController> /* GenericTypeInstSig */> /* GenericTypeInstSig */;

    ...
    implements winrt.windows.devices.i2c.II2cDevice
{
    ...
    static function FromIdAsync(deviceId: cxx.ConstRef<winrt.HString>, settings: cxx.ConstRef<winrt.windows.devices.i2c.I2cConnectionSettings>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.i2c.I2cDevice> /* GenericTypeInstSig */;
}

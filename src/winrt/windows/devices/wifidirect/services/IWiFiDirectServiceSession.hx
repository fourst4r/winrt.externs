...
@:native("winrt::Windows::Devices::WiFiDirect::Services::IWiFiDirectServiceSession")
extern interface IWiFiDirectServiceSession extends winrt.windows.foundation.IInspectable
{

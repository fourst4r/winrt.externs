...
@:native("winrt::Windows::Devices::WiFiDirect::WiFiDirectLegacySettings")
extern class WiFiDirectLegacySettings
    implements winrt.windows.devices.wifidirect.IWiFiDirectLegacySettings
{

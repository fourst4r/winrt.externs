...
@:native("winrt::Windows::Devices::WiFiDirect::WiFiDirectAdvertisement")
extern class WiFiDirectAdvertisement
    implements winrt.windows.devices.wifidirect.IWiFiDirectAdvertisement

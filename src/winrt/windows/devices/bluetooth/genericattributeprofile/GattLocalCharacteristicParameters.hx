    ...
    implements winrt.windows.devices.bluetooth.genericattributeprofile.IGattLocalCharacteristicParameters
{
    ...
    overload function CharacteristicProperties(value: ConstRef<winrt.windows.devices.bluetooth.genericattributeprofile.GattCharacteristicProperties>): Void;
    ...
    overload function UserDescription(value: ConstRef<winrt.HString>): Void;

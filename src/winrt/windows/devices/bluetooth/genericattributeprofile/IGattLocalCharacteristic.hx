...
@:native("winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalCharacteristic")
extern interface IGattLocalCharacteristic extends winrt.windows.foundation.IInspectable
{
    ...
    overload function SubscribedClientsChanged(handler: cxx.ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.devices.bluetooth.genericattributeprofile.GattLocalCharacteristic, winrt.windows.foundation.IInspectable> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    @:noExcept overload function SubscribedClientsChanged(token: cxx.ConstRef<winrt.EventToken>): Void;
    overload function ReadRequested(handler: cxx.ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.devices.bluetooth.genericattributeprofile.GattLocalCharacteristic, winrt.windows.devices.bluetooth.genericattributeprofile.GattReadRequestedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    @:noExcept overload function ReadRequested(token: cxx.ConstRef<winrt.EventToken>): Void;
    overload function WriteRequested(handler: cxx.ConstRef<winrt.windows.foundation.TypedEventHandler<winrt.windows.devices.bluetooth.genericattributeprofile.GattLocalCharacteristic, winrt.windows.devices.bluetooth.genericattributeprofile.GattWriteRequestedEventArgs> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    @:noExcept overload function WriteRequested(token: cxx.ConstRef<winrt.EventToken>): Void;
    overload function NotifyValueAsync(value: cxx.ConstRef<winrt.windows.storage.streams.IBuffer>): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVectorView<winrt.windows.devices.bluetooth.genericattributeprofile.GattClientNotificationResult> /* GenericTypeInstSig */> /* GenericTypeInstSig */;
    overload function NotifyValueAsync(value: cxx.ConstRef<winrt.windows.storage.streams.IBuffer>, subscribedClient: cxx.ConstRef<winrt.windows.devices.bluetooth.genericattributeprofile.GattSubscribedClient>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.bluetooth.genericattributeprofile.GattClientNotificationResult> /* GenericTypeInstSig */;
}

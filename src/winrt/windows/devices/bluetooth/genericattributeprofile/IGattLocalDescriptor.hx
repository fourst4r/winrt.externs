...
@:native("winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattLocalDescriptor")
extern interface IGattLocalDescriptor extends winrt.windows.foundation.IInspectable
{

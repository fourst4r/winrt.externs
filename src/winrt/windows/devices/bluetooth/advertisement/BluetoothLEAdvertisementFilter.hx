    ...
    implements winrt.windows.devices.bluetooth.advertisement.IBluetoothLEAdvertisementFilter
{
    ...
    overload function Advertisement(value: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.devices.bluetooth.advertisement.BluetoothLEAdvertisement>): Void;

...
@:native("winrt::Windows::Devices::Usb::IUsbInterruptInEndpointDescriptor")
extern interface IUsbInterruptInEndpointDescriptor extends winrt.windows.foundation.IInspectable
{

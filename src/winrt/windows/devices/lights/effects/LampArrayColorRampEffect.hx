...
{
    @:native("winrt::Windows::Devices::Lights::Effects::LampArrayColorRampEffect")
    static overload function make(lampArray: cxx.ConstRef<winrt.windows.devices.lights.LampArray>, lampIndexes: winrt.ArrayView<cxx.num.Int32>): winrt.windows.devices.lights.effects.LampArrayColorRampEffect;

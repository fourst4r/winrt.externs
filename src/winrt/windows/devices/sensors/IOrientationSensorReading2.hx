...
@:native("winrt::Windows::Devices::Sensors::IOrientationSensorReading2")
extern interface IOrientationSensorReading2 extends winrt.windows.foundation.IInspectable
{

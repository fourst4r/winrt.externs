    ...
    implements winrt.windows.devices.spi.ISpiController
{
    ...
    static function GetControllersAsync(provider: ConstRef<winrt.windows.devices.spi.provider.ISpiProvider>): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVectorView<winrt.windows.devices.spi.SpiController> /* GenericTypeInstSig */> /* GenericTypeInstSig */;
}

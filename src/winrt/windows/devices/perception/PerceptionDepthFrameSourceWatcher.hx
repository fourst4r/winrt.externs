...
@:native("winrt::Windows::Devices::Perception::PerceptionDepthFrameSourceWatcher")
extern class PerceptionDepthFrameSourceWatcher
    implements winrt.windows.devices.perception.IPerceptionDepthFrameSourceWatcher
{

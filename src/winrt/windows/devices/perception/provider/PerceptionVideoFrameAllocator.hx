...
{
    function new(maxOutstandingFrameCountForWrite: cxx.num.UInt32, format: cxx.ConstRef<winrt.windows.graphics.imaging.BitmapPixelFormat>, resolution: cxx.ConstRef<winrt.windows.foundation.Size>, alpha: cxx.ConstRef<winrt.windows.graphics.imaging.BitmapAlphaMode>);

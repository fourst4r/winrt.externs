...
@:native("winrt::Windows::Devices::Perception::IPerceptionDepthFrameSource")
extern interface IPerceptionDepthFrameSource extends winrt.windows.foundation.IInspectable
{

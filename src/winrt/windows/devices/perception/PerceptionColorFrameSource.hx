    ...
    implements winrt.windows.devices.perception.IPerceptionColorFrameSource2
{
    ...
    static function FromIdAsync(id: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.perception.PerceptionColorFrameSource> /* GenericTypeInstSig */;

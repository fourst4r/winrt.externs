...
@:native("winrt::Windows::Devices::SmartCards::SmartCardPinPolicy")
extern class SmartCardPinPolicy
    implements winrt.windows.devices.smartcards.ISmartCardPinPolicy
{
    function new();

    ...
    implements winrt.windows.devices.haptics.IVibrationDevice
{
    ...
    static function FromIdAsync(deviceId: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.haptics.VibrationDevice> /* GenericTypeInstSig */;

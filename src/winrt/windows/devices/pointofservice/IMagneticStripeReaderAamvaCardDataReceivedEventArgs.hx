...
@:native("winrt::Windows::Devices::PointOfService::IMagneticStripeReaderAamvaCardDataReceivedEventArgs")
extern interface IMagneticStripeReaderAamvaCardDataReceivedEventArgs extends winrt.windows.foundation.IInspectable
{

...
@:native("winrt::Windows::Devices::PointOfService::ISlipPrinterCapabilities2")
extern interface ISlipPrinterCapabilities2 extends winrt.windows.foundation.IInspectable
{

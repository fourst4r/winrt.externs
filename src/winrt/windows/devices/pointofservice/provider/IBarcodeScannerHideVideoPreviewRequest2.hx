...
@:native("winrt::Windows::Devices::PointOfService::Provider::IBarcodeScannerHideVideoPreviewRequest2")
extern interface IBarcodeScannerHideVideoPreviewRequest2 extends winrt.windows.foundation.IInspectable
{

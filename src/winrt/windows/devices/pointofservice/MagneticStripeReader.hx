    ...
    implements winrt.windows.foundation.IClosable
{
    ...
    function FromIdAsync(deviceId: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.pointofservice.MagneticStripeReader> /* GenericTypeInstSig */;
    ...
    static function FromIdAsync(deviceId: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.pointofservice.MagneticStripeReader> /* GenericTypeInstSig */;

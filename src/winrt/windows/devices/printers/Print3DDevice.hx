    ...
    implements winrt.windows.devices.printers.IPrint3DDevice
{
    ...
    static function FromIdAsync(deviceId: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.printers.Print3DDevice> /* GenericTypeInstSig */;

    ...
    implements winrt.windows.devices.serialcommunication.ISerialDevice
{
    ...
    static overload function GetDeviceSelector(portName: cxx.ConstRef<winrt.HString>): winrt.HString;
    static function GetDeviceSelectorFromUsbVidPid(vendorId: cxx.num.UInt16, productId: cxx.num.UInt16): winrt.HString;
    static function FromIdAsync(deviceId: cxx.ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.devices.serialcommunication.SerialDevice> /* GenericTypeInstSig */;
}

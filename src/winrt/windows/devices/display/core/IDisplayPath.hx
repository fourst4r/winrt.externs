...
extern interface IDisplayPath extends winrt.windows.foundation.IInspectable
{
    ...
    overload function SourceResolution(value: ConstRef<winrt.windows.foundation.IReference<winrt.windows.graphics.SizeInt32> /* temp_GenericTypeInstSig */>): Void;
    overload function SourcePixelFormat(): winrt.windows.graphics.directx.DirectXPixelFormat;
    overload function SourcePixelFormat(value: ConstRef<winrt.windows.graphics.directx.DirectXPixelFormat>): Void;
    ...
    overload function TargetResolution(value: ConstRef<winrt.windows.foundation.IReference<winrt.windows.graphics.SizeInt32> /* temp_GenericTypeInstSig */>): Void;
    ...
    overload function PresentationRate(value: ConstRef<winrt.windows.foundation.IReference<winrt.windows.devices.display.core.DisplayPresentationRate> /* temp_GenericTypeInstSig */>): Void;
    overload function IsInterlaced(): winrt.windows.foundation.IReference<Bool> /* GenericTypeInstSig */;
    overload function IsInterlaced(value: ConstRef<winrt.windows.foundation.IReference<Bool> /* temp_GenericTypeInstSig */>): Void;
    overload function WireFormat(): winrt.windows.devices.display.core.DisplayWireFormat;
    overload function WireFormat(value: ConstRef<winrt.windows.devices.display.core.DisplayWireFormat>): Void;
    overload function Rotation(): winrt.windows.devices.display.core.DisplayRotation;
    overload function Rotation(value: ConstRef<winrt.windows.devices.display.core.DisplayRotation>): Void;
    overload function Scaling(): winrt.windows.devices.display.core.DisplayPathScaling;
    overload function Scaling(value: ConstRef<winrt.windows.devices.display.core.DisplayPathScaling>): Void;
    function FindModes(flags: ConstRef<winrt.windows.devices.display.core.DisplayModeQueryOptions>): winrt.windows.foundation.collections.IVectorView<winrt.windows.devices.display.core.DisplayModeInfo> /* GenericTypeInstSig */;
    function ApplyPropertiesFromMode(modeResult: ConstRef<winrt.windows.devices.display.core.DisplayModeInfo>): Void;

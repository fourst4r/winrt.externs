    ...
    implements winrt.windows.foundation.IClosable
{
    ...
    static function Create(options: cxx.ConstRef<winrt.windows.devices.display.core.DisplayManagerOptions>): winrt.windows.devices.display.core.DisplayManager;
}

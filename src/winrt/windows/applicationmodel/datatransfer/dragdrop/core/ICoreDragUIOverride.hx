...
@:native("winrt::Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragUIOverride")
extern interface ICoreDragUIOverride extends winrt.windows.foundation.IInspectable
{

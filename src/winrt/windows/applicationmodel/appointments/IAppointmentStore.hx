...
@:native("winrt::Windows::ApplicationModel::Appointments::IAppointmentStore")
extern interface IAppointmentStore extends winrt.windows.foundation.IInspectable
{
    overload function ChangeTracker(): winrt.windows.applicationmodel.appointments.AppointmentStoreChangeTracker;
    function CreateAppointmentCalendarAsync(name: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.applicationmodel.appointments.AppointmentCalendar> /* GenericTypeInstSig */;

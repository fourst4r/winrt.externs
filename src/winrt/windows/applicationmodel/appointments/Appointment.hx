    ...
    implements winrt.windows.applicationmodel.appointments.IAppointment3
{
    ...
    overload function Reminder(value: ConstRef<winrt.windows.foundation.IReference<winrt.windows.foundation.TimeSpan> /* temp_GenericTypeInstSig */>): Void;
    overload function Organizer(): winrt.windows.applicationmodel.appointments.AppointmentOrganizer;
    overload function Organizer(value: ConstRef<winrt.windows.applicationmodel.appointments.AppointmentOrganizer>): Void;
    ...
    overload function BusyStatus(value: ConstRef<winrt.windows.applicationmodel.appointments.AppointmentBusyStatus>): Void;
    ...
    overload function Sensitivity(value: ConstRef<winrt.windows.applicationmodel.appointments.AppointmentSensitivity>): Void;
    ...
    overload function RoamingId(value: ConstRef<winrt.HString>): Void;
    ...
    overload function OnlineMeetingLink(value: ConstRef<winrt.HString>): Void;
    overload function ReplyTime(): winrt.windows.foundation.IReference<winrt.windows.foundation.DateTime> /* GenericTypeInstSig */;
    overload function ReplyTime(value: ConstRef<winrt.windows.foundation.IReference<winrt.windows.foundation.DateTime> /* temp_GenericTypeInstSig */>): Void;
    overload function UserResponse(): winrt.windows.applicationmodel.appointments.AppointmentParticipantResponse;
    overload function UserResponse(value: ConstRef<winrt.windows.applicationmodel.appointments.AppointmentParticipantResponse>): Void;

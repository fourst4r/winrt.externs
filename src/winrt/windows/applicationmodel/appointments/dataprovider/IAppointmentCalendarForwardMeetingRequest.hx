...
@:native("winrt::Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarForwardMeetingRequest")
extern interface IAppointmentCalendarForwardMeetingRequest extends winrt.windows.foundation.IInspectable
{

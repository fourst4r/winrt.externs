...
@:native("winrt::Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarProposeNewTimeForMeetingRequest")
extern interface IAppointmentCalendarProposeNewTimeForMeetingRequest extends winrt.windows.foundation.IInspectable
{

    ...
    implements winrt.windows.applicationmodel.IAppInstance
{
    ...
    static function FindOrRegisterInstanceForKey(key: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.applicationmodel.AppInstance;

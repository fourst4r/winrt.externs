    ...
    implements winrt.windows.applicationmodel.IAppInstance
{
    ...
    function FindOrRegisterInstanceForKey(key: cxx.ConstRef<winrt.HString>): winrt.windows.applicationmodel.AppInstance;
    ...
    static function FindOrRegisterInstanceForKey(key: cxx.ConstRef<winrt.HString>): winrt.windows.applicationmodel.AppInstance;

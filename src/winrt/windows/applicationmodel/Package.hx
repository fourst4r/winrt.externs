    ...
    implements winrt.windows.applicationmodel.IPackage9
{
    ...
    function GetContentGroupAsync(name: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.applicationmodel.PackageContentGroup> /* GenericTypeInstSig */;
    overload function StageContentGroupsAsync(names: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVector<winrt.windows.applicationmodel.PackageContentGroup> /* GenericTypeInstSig */> /* GenericTypeInstSig */;
    overload function StageContentGroupsAsync(names: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, moveToHeadOfQueue: Bool): winrt.windows.foundation.IAsyncOperation<winrt.windows.foundation.collections.IVector<winrt.windows.applicationmodel.PackageContentGroup> /* GenericTypeInstSig */> /* GenericTypeInstSig */;

...
@:native("winrt::Windows::ApplicationModel::AppExtensions::IAppExtensionPackageUpdatedEventArgs")
extern interface IAppExtensionPackageUpdatedEventArgs extends winrt.windows.foundation.IInspectable
{

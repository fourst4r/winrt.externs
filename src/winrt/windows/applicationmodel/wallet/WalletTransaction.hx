...
@:native("winrt::Windows::ApplicationModel::Wallet::WalletTransaction")
extern class WalletTransaction
    implements winrt.windows.applicationmodel.wallet.IWalletTransaction
{
    function new();

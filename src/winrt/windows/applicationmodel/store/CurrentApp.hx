...
extern class CurrentApp
{
    ...
    static function GetCustomerPurchaseIdAsync(serviceTicket: ConstRef<winrt.HString>, publisherUserId: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.HString> /* GenericTypeInstSig */;
    static function GetCustomerCollectionsIdAsync(serviceTicket: ConstRef<winrt.HString>, publisherUserId: ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.HString> /* GenericTypeInstSig */;
    ...
    static function ReportProductFulfillment(productId: ConstRef<winrt.HString>): Void;

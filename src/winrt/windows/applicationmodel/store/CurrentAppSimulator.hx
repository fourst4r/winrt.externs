...
extern class CurrentAppSimulator
{
    ...
    static function ReloadSimulatorAsync(simulatorSettingsFile: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.storage.StorageFile>): winrt.windows.foundation.IAsyncAction;

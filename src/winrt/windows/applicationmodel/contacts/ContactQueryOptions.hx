    ...
    implements winrt.windows.applicationmodel.contacts.IContactQueryOptions
{
    function new();
    @:native("winrt::Windows::ApplicationModel::Contacts::ContactQueryOptions")
    /* explicit */ static overload function make(text: cxx.ConstRef<winrt.HString>): winrt.windows.applicationmodel.contacts.ContactQueryOptions;
    @:native("winrt::Windows::ApplicationModel::Contacts::ContactQueryOptions")
    static overload function make(text: cxx.ConstRef<winrt.HString>, fields: cxx.ConstRef<winrt.windows.applicationmodel.contacts.ContactQuerySearchFields>): winrt.windows.applicationmodel.contacts.ContactQueryOptions;
    ...
    overload function DesiredFields(value: cxx.ConstRef<winrt.windows.applicationmodel.contacts.ContactQueryDesiredFields>): Void;
    overload function DesiredOperations(): winrt.windows.applicationmodel.contacts.ContactAnnotationOperations;
    overload function DesiredOperations(value: cxx.ConstRef<winrt.windows.applicationmodel.contacts.ContactAnnotationOperations>): Void;

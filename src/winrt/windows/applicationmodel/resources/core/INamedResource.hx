...
extern interface INamedResource extends winrt.windows.foundation.IInspectable
{
    ...
    overload function Resolve(resourceContext: cxx.ConstRef<winrt.windows.applicationmodel.resources.core.ResourceContext>): winrt.windows.applicationmodel.resources.core.ResourceCandidate;
    ...
    overload function ResolveAll(resourceContext: cxx.ConstRef<winrt.windows.applicationmodel.resources.core.ResourceContext>): winrt.windows.foundation.collections.IVectorView<winrt.windows.applicationmodel.resources.core.ResourceCandidate> /* GenericTypeInstSig */;
}

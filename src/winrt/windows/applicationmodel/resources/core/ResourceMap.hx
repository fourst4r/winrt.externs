    ...
    implements winrt.windows.applicationmodel.resources.core.IResourceMap
{
    ...
    function Lookup(key: ConstRef<winrt.HString>): winrt.windows.applicationmodel.resources.core.NamedResource;
    overload function Size(): UInt32;
    function HasKey(key: ConstRef<winrt.HString>): Bool;
    function Split(first: Ref<winrt.windows.foundation.collections.IMapView<winrt.HString, winrt.windows.applicationmodel.resources.core.NamedResource> /* GenericTypeInstSig */>, second: Ref<winrt.windows.foundation.collections.IMapView<winrt.HString, winrt.windows.applicationmodel.resources.core.NamedResource> /* GenericTypeInstSig */>): Void;

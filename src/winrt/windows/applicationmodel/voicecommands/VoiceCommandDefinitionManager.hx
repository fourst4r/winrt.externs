...
{
    static function InstallCommandDefinitionsFromStorageFileAsync(file: cxx.ConstRef<winrt.windows.storage.StorageFile>): winrt.windows.foundation.IAsyncAction;

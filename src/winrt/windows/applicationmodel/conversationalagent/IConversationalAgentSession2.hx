...
{
    function RequestActivationAsync(activationKind: ConstRef<winrt.windows.applicationmodel.conversationalagent.ConversationalAgentActivationKind>): winrt.windows.foundation.IAsyncOperation<winrt.windows.applicationmodel.conversationalagent.ConversationalAgentActivationResult> /* GenericTypeInstSig */;
    function RequestActivation(activationKind: ConstRef<winrt.windows.applicationmodel.conversationalagent.ConversationalAgentActivationKind>): winrt.windows.applicationmodel.conversationalagent.ConversationalAgentActivationResult;

...
@:native("winrt::Windows::ApplicationModel::Email::EmailMailbox")
extern class EmailMailbox
    implements winrt.windows.applicationmodel.email.IEmailMailbox
    implements winrt.windows.applicationmodel.email.IEmailMailbox2
    implements winrt.windows.applicationmodel.email.IEmailMailbox3
    implements winrt.windows.applicationmodel.email.IEmailMailbox4
    implements winrt.windows.applicationmodel.email.IEmailMailbox5
{

    ...
    implements winrt.windows.applicationmodel.email.IEmailQueryOptions
{
    function new();
    @:native("winrt::Windows::ApplicationModel::Email::EmailQueryOptions")
    /* explicit */ static overload function make(text: ConstRef<winrt.HString>): winrt.windows.applicationmodel.email.EmailQueryOptions;
    @:native("winrt::Windows::ApplicationModel::Email::EmailQueryOptions")
    static overload function make(text: ConstRef<winrt.HString>, fields: ConstRef<winrt.windows.applicationmodel.email.EmailQuerySearchFields>): winrt.windows.applicationmodel.email.EmailQueryOptions;

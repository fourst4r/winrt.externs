...
@:native("winrt::Windows::ApplicationModel::Email::DataProvider::IEmailMailboxUpdateMeetingResponseRequest")
extern interface IEmailMailboxUpdateMeetingResponseRequest extends winrt.windows.foundation.IInspectable
{

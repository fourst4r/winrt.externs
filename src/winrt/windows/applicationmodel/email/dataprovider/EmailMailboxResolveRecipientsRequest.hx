    ...
    implements winrt.windows.applicationmodel.email.dataprovider.IEmailMailboxResolveRecipientsRequest
{
    ...
    function ReportCompletedAsync(resolutionResults: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.windows.applicationmodel.email.EmailRecipientResolutionResult> /* temp_GenericTypeInstSig */>): winrt.windows.foundation.IAsyncAction;

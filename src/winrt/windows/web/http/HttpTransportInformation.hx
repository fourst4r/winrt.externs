...
@:native("winrt::Windows::Web::Http::HttpTransportInformation")
extern class HttpTransportInformation
    implements winrt.windows.web.http.IHttpTransportInformation

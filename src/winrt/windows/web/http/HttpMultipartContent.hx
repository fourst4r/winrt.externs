    ...
    implements winrt.windows.foundation.IStringable
{
    function new();
    @:native("winrt::Windows::Web::Http::HttpMultipartContent")
    /* explicit */ static overload function make(subtype: cxx.ConstRef<winrt.HString>): winrt.windows.web.http.HttpMultipartContent;
    @:native("winrt::Windows::Web::Http::HttpMultipartContent")
    static overload function make(subtype: cxx.ConstRef<winrt.HString>, boundary: cxx.ConstRef<winrt.HString>): winrt.windows.web.http.HttpMultipartContent;

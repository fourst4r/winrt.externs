    ...
    implements winrt.windows.foundation.IStringable
{
    ...
    function GetAt(index: cxx.num.UInt32): winrt.windows.web.http.headers.HttpExpectationHeaderValue;
    ...
    function IndexOf(value: cxx.ConstRef<winrt.windows.web.http.headers.HttpExpectationHeaderValue>, index: cxx.Ref<cxx.num.UInt32>): Bool;
    function SetAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.web.http.headers.HttpExpectationHeaderValue>): Void;
    function InsertAt(index: cxx.num.UInt32, value: cxx.ConstRef<winrt.windows.web.http.headers.HttpExpectationHeaderValue>): Void;
    function RemoveAt(index: cxx.num.UInt32): Void;
    function Append(value: cxx.ConstRef<winrt.windows.web.http.headers.HttpExpectationHeaderValue>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: cxx.num.UInt32, items: winrt.ArrayView<winrt.windows.web.http.headers.HttpExpectationHeaderValue>): cxx.num.UInt32;

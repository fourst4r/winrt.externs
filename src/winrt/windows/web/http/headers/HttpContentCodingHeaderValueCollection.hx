    ...
    implements winrt.windows.foundation.IStringable
{
    ...
    function GetAt(index: UInt32): winrt.windows.web.http.headers.HttpContentCodingHeaderValue;
    ...
    function IndexOf(value: ConstRef<winrt.windows.web.http.headers.HttpContentCodingHeaderValue>, index: Ref<UInt32>): Bool;
    function SetAt(index: UInt32, value: ConstRef<winrt.windows.web.http.headers.HttpContentCodingHeaderValue>): Void;
    function InsertAt(index: UInt32, value: ConstRef<winrt.windows.web.http.headers.HttpContentCodingHeaderValue>): Void;
    function RemoveAt(index: UInt32): Void;
    function Append(value: ConstRef<winrt.windows.web.http.headers.HttpContentCodingHeaderValue>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: UInt32, items: winrt.ArrayView<winrt.windows.web.http.headers.HttpContentCodingHeaderValue>): UInt32;

    ...
    implements winrt.windows.foundation.IStringable
{
    ...
    function GetAt(index: UInt32): winrt.windows.web.http.headers.HttpTransferCodingHeaderValue;
    ...
    function IndexOf(value: ConstRef<winrt.windows.web.http.headers.HttpTransferCodingHeaderValue>, index: Ref<UInt32>): Bool;
    function SetAt(index: UInt32, value: ConstRef<winrt.windows.web.http.headers.HttpTransferCodingHeaderValue>): Void;
    function InsertAt(index: UInt32, value: ConstRef<winrt.windows.web.http.headers.HttpTransferCodingHeaderValue>): Void;
    function RemoveAt(index: UInt32): Void;
    function Append(value: ConstRef<winrt.windows.web.http.headers.HttpTransferCodingHeaderValue>): Void;
    function RemoveAtEnd(): Void;
    function Clear(): Void;
    function GetMany(startIndex: UInt32, items: winrt.ArrayView<winrt.windows.web.http.headers.HttpTransferCodingHeaderValue>): UInt32;

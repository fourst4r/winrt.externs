    ...
    implements winrt.windows.web.syndication.ISyndicationText
{
    function new();
    @:native("winrt::Windows::Web::Syndication::SyndicationText")
    /* explicit */ static overload function make(text: ConstRef<winrt.HString>): winrt.windows.web.syndication.SyndicationText;
    @:native("winrt::Windows::Web::Syndication::SyndicationText")
    static overload function make(text: ConstRef<winrt.HString>, type: ConstRef<winrt.windows.web.syndication.SyndicationTextType>): winrt.windows.web.syndication.SyndicationText;

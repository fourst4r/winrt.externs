    ...
    implements winrt.windows.web.syndication.ISyndicationNode
{
    function new();
    @:native("winrt::Windows::Web::Syndication::SyndicationNode")
    static overload function make(nodeName: cxx.ConstRef<winrt.HString>, nodeNamespace: cxx.ConstRef<winrt.HString>, nodeValue: cxx.ConstRef<winrt.HString>): winrt.windows.web.syndication.SyndicationNode;

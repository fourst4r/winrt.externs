...
@:native("winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession")
extern class PrintWorkflowJobBackgroundSession
    implements winrt.windows.graphics.printing.workflow.IPrintWorkflowJobBackgroundSession
{

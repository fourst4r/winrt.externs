...
extern interface IPrintWorkflowPdlModificationRequestedEventArgs extends winrt.windows.foundation.IInspectable
{
    ...
    function CreateJobOnPrinterWithAttributes(jobAttributes: cxx.ConstRef<winrt.windows.foundation.collections.IIterable<winrt.windows.foundation.collections.IKeyValuePair<winrt.HString, winrt.windows.devices.printers.IppAttributeValue> /* GenericTypeInstSig */> /* temp_GenericTypeInstSig */>, targetContentType: cxx.ConstRef<winrt.HString>): winrt.windows.graphics.printing.workflow.PrintWorkflowPdlTargetStream;
    function CreateJobOnPrinterWithAttributesBuffer(jobAttributesBuffer: cxx.ConstRef<winrt.windows.storage.streams.IBuffer>, targetContentType: cxx.ConstRef<winrt.HString>): winrt.windows.graphics.printing.workflow.PrintWorkflowPdlTargetStream;

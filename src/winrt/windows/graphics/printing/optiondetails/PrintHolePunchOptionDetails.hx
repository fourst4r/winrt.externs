...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintHolePunchOptionDetails")
extern class PrintHolePunchOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintHolePunchOptionDetails
{

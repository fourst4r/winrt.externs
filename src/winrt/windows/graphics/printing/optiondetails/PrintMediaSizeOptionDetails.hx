...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintMediaSizeOptionDetails")
extern class PrintMediaSizeOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintMediaSizeOptionDetails
{

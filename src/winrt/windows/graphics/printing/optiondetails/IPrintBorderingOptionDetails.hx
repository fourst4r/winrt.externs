...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintBorderingOptionDetails")
extern interface IPrintBorderingOptionDetails extends winrt.windows.foundation.IInspectable
{

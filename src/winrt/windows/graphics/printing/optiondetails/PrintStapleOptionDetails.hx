...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintStapleOptionDetails")
extern class PrintStapleOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintStapleOptionDetails
{

...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintQualityOptionDetails")
extern interface IPrintQualityOptionDetails extends winrt.windows.foundation.IInspectable
{

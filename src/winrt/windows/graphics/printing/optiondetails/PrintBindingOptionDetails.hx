...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintBindingOptionDetails")
extern class PrintBindingOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintBindingOptionDetails
{

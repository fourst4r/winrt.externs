...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintColorModeOptionDetails")
extern class PrintColorModeOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintColorModeOptionDetails
{

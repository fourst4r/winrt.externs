...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintDuplexOptionDetails")
extern class PrintDuplexOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintDuplexOptionDetails
{

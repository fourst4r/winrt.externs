...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintBorderingOptionDetails")
extern class PrintBorderingOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintBorderingOptionDetails
{

...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintDuplexOptionDetails")
extern interface IPrintDuplexOptionDetails extends winrt.windows.foundation.IInspectable
{

...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintCopiesOptionDetails")
extern interface IPrintCopiesOptionDetails extends winrt.windows.foundation.IInspectable
{

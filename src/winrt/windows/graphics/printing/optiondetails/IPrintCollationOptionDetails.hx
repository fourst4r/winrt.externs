...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintCollationOptionDetails")
extern interface IPrintCollationOptionDetails extends winrt.windows.foundation.IInspectable
{

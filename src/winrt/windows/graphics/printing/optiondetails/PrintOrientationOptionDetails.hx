...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::PrintOrientationOptionDetails")
extern class PrintOrientationOptionDetails
    ...
    implements winrt.windows.graphics.printing.optiondetails.IPrintOrientationOptionDetails
{

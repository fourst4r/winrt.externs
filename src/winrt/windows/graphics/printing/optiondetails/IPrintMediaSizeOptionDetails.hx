...
@:native("winrt::Windows::Graphics::Printing::OptionDetails::IPrintMediaSizeOptionDetails")
extern interface IPrintMediaSizeOptionDetails extends winrt.windows.foundation.IInspectable
{

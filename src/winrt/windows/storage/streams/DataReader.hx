...
{
    /* explicit */ function new(inputStream: ConstRef<winrt.windows.storage.streams.IInputStream>);
    ...
    static function FromBuffer(buffer: ConstRef<winrt.windows.storage.streams.IBuffer>): winrt.windows.storage.streams.DataReader;
}

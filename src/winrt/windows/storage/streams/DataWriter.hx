    ...
    implements winrt.windows.foundation.IClosable
{
    function new();
    @:native("winrt::Windows::Storage::Streams::DataWriter")
    /* explicit */ static overload function make(outputStream: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.storage.streams.IOutputStream>): winrt.windows.storage.streams.DataWriter;

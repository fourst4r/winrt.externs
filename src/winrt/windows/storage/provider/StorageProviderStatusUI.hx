...
@:native("winrt::Windows::Storage::Provider::StorageProviderStatusUI")
extern class StorageProviderStatusUI
    implements winrt.windows.storage.provider.IStorageProviderStatusUI
{
    function new();

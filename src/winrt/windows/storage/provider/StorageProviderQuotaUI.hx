...
@:native("winrt::Windows::Storage::Provider::StorageProviderQuotaUI")
extern class StorageProviderQuotaUI
    implements winrt.windows.storage.provider.IStorageProviderQuotaUI
{
    function new();

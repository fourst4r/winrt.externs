    ...
    implements winrt.windows.globalization.ITimeZoneOnCalendar
{
    function new();
    @:native("winrt::Windows::Globalization::Calendar")
    /* explicit */ static overload function make(languages: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>): winrt.windows.globalization.Calendar;
    @:native("winrt::Windows::Globalization::Calendar")
    static overload function make(languages: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, calendar: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, clock: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.globalization.Calendar;
    @:native("winrt::Windows::Globalization::Calendar")
    static overload function make(languages: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, calendar: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, clock: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, timeZoneId: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>): winrt.windows.globalization.Calendar;

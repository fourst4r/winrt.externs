    ...
    implements winrt.windows.globalization.ITimeZoneOnCalendar
{
    function new();
    @:native("winrt::Windows::Globalization::Calendar")
    /* explicit */ static overload function make(languages: ConstRef<winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>): winrt.windows.globalization.Calendar;
    @:native("winrt::Windows::Globalization::Calendar")
    static overload function make(languages: ConstRef<winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, calendar: ConstRef<winrt.HString>, clock: ConstRef<winrt.HString>): winrt.windows.globalization.Calendar;
    @:native("winrt::Windows::Globalization::Calendar")
    static overload function make(languages: ConstRef<winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, calendar: ConstRef<winrt.HString>, clock: ConstRef<winrt.HString>, timeZoneId: ConstRef<winrt.HString>): winrt.windows.globalization.Calendar;

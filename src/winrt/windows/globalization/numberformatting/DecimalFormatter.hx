    ...
    implements winrt.windows.globalization.numberformatting.ISignedZeroOption
{
    function new();
    @:native("winrt::Windows::Globalization::NumberFormatting::DecimalFormatter")
    static overload function make(languages: ConstRef<winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, geographicRegion: ConstRef<winrt.HString>): winrt.windows.globalization.numberformatting.DecimalFormatter;

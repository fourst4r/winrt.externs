    ...
    implements winrt.windows.globalization.numberformatting.ISignedZeroOption
{
    function new();
    @:native("winrt::Windows::Globalization::NumberFormatting::DecimalFormatter")
    static overload function make(languages: cxx.ConstRef<winrt.windows.foundation.collections.IIterable<winrt.HString> /* temp_GenericTypeInstSig */>, geographicRegion: cxx.ConstRef<winrt.HString>): winrt.windows.globalization.numberformatting.DecimalFormatter;

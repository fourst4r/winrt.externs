...
extern class WindowsIntegrityPolicy
{
    ...
    static overload function PolicyChanged(handler: ConstRef<winrt.windows.foundation.EventHandler<winrt.windows.foundation.IInspectable> /* temp_GenericTypeInstSig */>): winrt.EventToken;
    static overload function PolicyChanged(token: ConstRef<winrt.EventToken>): Void;
}

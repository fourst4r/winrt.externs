    ...
    implements winrt.windows.system.threading.IThreadPoolTimer
{
    ...
    static overload function CreatePeriodicTimer(handler: ConstRef<winrt.windows.system.threading.TimerElapsedHandler>, period: ConstRef<winrt.windows.foundation.TimeSpan>): winrt.windows.system.threading.ThreadPoolTimer;
    static overload function CreateTimer(handler: ConstRef<winrt.windows.system.threading.TimerElapsedHandler>, delay: ConstRef<winrt.windows.foundation.TimeSpan>): winrt.windows.system.threading.ThreadPoolTimer;
    static overload function CreatePeriodicTimer(handler: ConstRef<winrt.windows.system.threading.TimerElapsedHandler>, period: ConstRef<winrt.windows.foundation.TimeSpan>, destroyed: ConstRef<winrt.windows.system.threading.TimerDestroyedHandler>): winrt.windows.system.threading.ThreadPoolTimer;
    static overload function CreateTimer(handler: ConstRef<winrt.windows.system.threading.TimerElapsedHandler>, delay: ConstRef<winrt.windows.foundation.TimeSpan>, destroyed: ConstRef<winrt.windows.system.threading.TimerDestroyedHandler>): winrt.windows.system.threading.ThreadPoolTimer;
}

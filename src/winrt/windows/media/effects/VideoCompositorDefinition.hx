    ...
    implements winrt.windows.media.effects.IVideoCompositorDefinition
{
    ...
    @:native("winrt::Windows::Media::Effects::VideoCompositorDefinition")
    static overload function make(activatableClassId: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.HString>, props: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IPropertySet>): winrt.windows.media.effects.VideoCompositorDefinition;

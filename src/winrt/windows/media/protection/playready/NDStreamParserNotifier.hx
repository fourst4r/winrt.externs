...
@:native("winrt::Windows::Media::Protection::PlayReady::NDStreamParserNotifier")
extern class NDStreamParserNotifier
    implements winrt.windows.media.protection.playready.INDStreamParserNotifier
{
    function new();

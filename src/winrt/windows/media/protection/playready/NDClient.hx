...
{
    function new(downloadEngine: ConstRef<winrt.windows.media.protection.playready.INDDownloadEngine>, streamParser: ConstRef<winrt.windows.media.protection.playready.INDStreamParser>, pMessenger: ConstRef<winrt.windows.media.protection.playready.INDMessenger>);

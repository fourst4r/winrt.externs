...
@:native("winrt::Windows::Media::Control::GlobalSystemMediaTransportControlsSession")
extern class GlobalSystemMediaTransportControlsSession
    implements winrt.windows.media.control.IGlobalSystemMediaTransportControlsSession
{

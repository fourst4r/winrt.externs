    ...
    implements winrt.windows.media.speechrecognition.ISpeechRecognizer2
{
    function new();
    @:native("winrt::Windows::Media::SpeechRecognition::SpeechRecognizer")
    /* explicit */ static overload function make(language: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.globalization.Language>): winrt.windows.media.speechrecognition.SpeechRecognizer;
    ...
    static function TrySetSystemSpeechLanguageAsync(speechLanguage: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.globalization.Language>): winrt.windows.foundation.IAsyncOperation<Bool> /* GenericTypeInstSig */;
}

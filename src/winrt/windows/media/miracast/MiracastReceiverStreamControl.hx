    ...
    implements winrt.windows.media.miracast.IMiracastReceiverStreamControl
{
    ...
    function SuggestVideoStreamSettings(settings: ConstRef<winrt.windows.media.miracast.MiracastReceiverVideoStreamSettings>): Void;
    function SuggestVideoStreamSettingsAsync(settings: ConstRef<winrt.windows.media.miracast.MiracastReceiverVideoStreamSettings>): winrt.windows.foundation.IAsyncAction;

    ...
    implements winrt.windows.media.editing.IBackgroundAudioTrack
{
    ...
    static function CreateFromEmbeddedAudioTrack(embeddedAudioTrack: cxx.ConstRef<winrt.windows.media.editing.EmbeddedAudioTrack>): winrt.windows.media.editing.BackgroundAudioTrack;
    static function CreateFromFileAsync(file: cxx.ConstRef<winrt.windows.storage.IStorageFile>): winrt.windows.foundation.IAsyncOperation<winrt.windows.media.editing.BackgroundAudioTrack> /* GenericTypeInstSig */;
}

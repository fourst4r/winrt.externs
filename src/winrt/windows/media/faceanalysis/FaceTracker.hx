    ...
    implements winrt.windows.media.faceanalysis.IFaceTracker
{
    ...
    static function IsBitmapPixelFormatSupported(bitmapPixelFormat: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.graphics.imaging.BitmapPixelFormat>): Bool;

...
@:native("winrt::Windows::Media::Playback::MediaPlaybackCommandManagerCommandBehavior")
extern class MediaPlaybackCommandManagerCommandBehavior
    implements winrt.windows.media.playback.IMediaPlaybackCommandManagerCommandBehavior
{

...
@:native("winrt::Windows::Media::Playback::IMediaPlaybackCommandManager")
extern interface IMediaPlaybackCommandManager extends winrt.windows.foundation.IInspectable
{

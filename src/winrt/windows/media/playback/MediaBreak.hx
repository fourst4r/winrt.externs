...
{
    /* explicit */ function new(insertionMethod: ConstRef<winrt.windows.media.playback.MediaBreakInsertionMethod>);
    @:native("winrt::Windows::Media::Playback::MediaBreak")
    static overload function make(insertionMethod: ConstRef<winrt.windows.media.playback.MediaBreakInsertionMethod>, presentationPosition: ConstRef<winrt.windows.foundation.TimeSpan>): winrt.windows.media.playback.MediaBreak;

...
extern interface IDialApp extends winrt.windows.foundation.IInspectable
{
    ...
    function RequestLaunchAsync(appArgument: cxx.ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.media.dialprotocol.DialAppLaunchResult> /* GenericTypeInstSig */;

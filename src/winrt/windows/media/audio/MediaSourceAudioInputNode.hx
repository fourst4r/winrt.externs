...
@:native("winrt::Windows::Media::Audio::MediaSourceAudioInputNode")
extern class MediaSourceAudioInputNode
    ...
    implements winrt.windows.media.audio.IMediaSourceAudioInputNode
{

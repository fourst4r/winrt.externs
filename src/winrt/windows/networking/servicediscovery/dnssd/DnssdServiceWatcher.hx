...
@:native("winrt::Windows::Networking::ServiceDiscovery::Dnssd::DnssdServiceWatcher")
extern class DnssdServiceWatcher
    implements winrt.windows.networking.servicediscovery.dnssd.IDnssdServiceWatcher
{

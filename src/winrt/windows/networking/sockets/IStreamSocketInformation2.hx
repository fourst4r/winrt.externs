...
@:native("winrt::Windows::Networking::Sockets::IStreamSocketInformation2")
extern interface IStreamSocketInformation2 extends winrt.windows.foundation.IInspectable
{

...
extern interface IESimProfile extends winrt.windows.foundation.IInspectable
{
    ...
    function SetNicknameAsync(newNickname: cxx.ConstRef<winrt.HString>): winrt.windows.foundation.IAsyncOperation<winrt.windows.networking.networkoperators.ESimOperationResult> /* GenericTypeInstSig */;
}

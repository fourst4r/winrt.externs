...
@:native("winrt::Windows::Networking::NetworkOperators::IMobileBroadbandCellLte")
extern interface IMobileBroadbandCellLte extends winrt.windows.foundation.IInspectable
{

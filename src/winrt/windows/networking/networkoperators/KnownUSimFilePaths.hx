...
extern class KnownUSimFilePaths
{
    ...
    static overload function EFOpl(): winrt.windows.foundation.collections.IVectorView<UInt32> /* GenericTypeInstSig */;
    static overload function EFPnn(): winrt.windows.foundation.collections.IVectorView<UInt32> /* GenericTypeInstSig */;

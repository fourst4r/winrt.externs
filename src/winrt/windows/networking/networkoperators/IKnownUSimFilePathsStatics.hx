...
extern interface IKnownUSimFilePathsStatics extends winrt.windows.foundation.IInspectable
{
    ...
    overload function EFOpl(): winrt.windows.foundation.collections.IVectorView<UInt32> /* GenericTypeInstSig */;
    overload function EFPnn(): winrt.windows.foundation.collections.IVectorView<UInt32> /* GenericTypeInstSig */;

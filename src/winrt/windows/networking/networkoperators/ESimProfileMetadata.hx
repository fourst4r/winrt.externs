...
@:native("winrt::Windows::Networking::NetworkOperators::ESimProfileMetadata")
extern class ESimProfileMetadata
    implements winrt.windows.networking.networkoperators.IESimProfileMetadata
{

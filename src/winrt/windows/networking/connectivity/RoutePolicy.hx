...
{
    function new(connectionProfile: cxx.ConstRef<winrt.windows.networking.connectivity.ConnectionProfile>, hostName: cxx.ConstRef<winrt.windows.networking.HostName>, type: cxx.ConstRef<winrt.windows.networking.DomainNameType>);

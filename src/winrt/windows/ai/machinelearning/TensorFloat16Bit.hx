...
@:native("winrt::Windows::AI::MachineLearning::TensorFloat16Bit")
extern class TensorFloat16Bit
    implements winrt.windows.ai.machinelearning.ITensorFloat16Bit
    ...
    implements winrt.windows.foundation.IMemoryBuffer
{
    ...
    function Close(): Void;
    function CreateFromShapeArrayAndDataArray(shape: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Int64>, data: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Float32>): winrt.windows.ai.machinelearning.TensorFloat16Bit;
    function CreateFromBuffer(shape: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Int64>, buffer: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.storage.streams.IBuffer>): winrt.windows.ai.machinelearning.TensorFloat16Bit;
    ...
    static overload function Create(): winrt.windows.ai.machinelearning.TensorFloat16Bit;
    static overload function Create(shape: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.foundation.collections.IIterable<#if reflaxe.cpp cxx.num. #else cpp. #end Int64> /* temp_GenericTypeInstSig */>): winrt.windows.ai.machinelearning.TensorFloat16Bit;
    ...
    static function CreateFromShapeArrayAndDataArray(shape: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Int64>, data: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Float32>): winrt.windows.ai.machinelearning.TensorFloat16Bit;
    static function CreateFromBuffer(shape: winrt.ArrayView<#if reflaxe.cpp cxx.num. #else cpp. #end Int64>, buffer: #if reflaxe.cpp cxx.ConstRef #else cpp.Reference #end <winrt.windows.storage.streams.IBuffer>): winrt.windows.ai.machinelearning.TensorFloat16Bit;
}

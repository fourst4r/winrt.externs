...
@:native("winrt::Windows::AI::MachineLearning::ITensorFeatureDescriptor")
extern interface ITensorFeatureDescriptor extends winrt.windows.foundation.IInspectable
{

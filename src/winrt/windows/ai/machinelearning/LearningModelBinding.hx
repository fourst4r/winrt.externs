...
{
    @:native("winrt::Windows::AI::MachineLearning::LearningModelBinding")
    /* explicit */ static overload function make(session: cxx.ConstRef<winrt.windows.ai.machinelearning.LearningModelSession>): winrt.windows.ai.machinelearning.LearningModelBinding;

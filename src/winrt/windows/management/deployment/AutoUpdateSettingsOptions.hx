...
@:native("winrt::Windows::Management::Deployment::AutoUpdateSettingsOptions")
extern class AutoUpdateSettingsOptions
    implements winrt.windows.management.deployment.IAutoUpdateSettingsOptions
{
    function new();
    ...
    static function CreateFromAppInstallerInfo(appInstallerInfo: cxx.ConstRef<winrt.windows.applicationmodel.AppInstallerInfo>): winrt.windows.management.deployment.AutoUpdateSettingsOptions;
}
